...
<div class="wrap">
    ...
    <div class="yx_right_menu fr">
        ...
        <input type="hidden" id="videoNameC" value="<?php echo $data['resource_name']?>">
        <input type="hidden" id="videoUrlC" value="<?php echo $data['resource']?>">
        <input type="hidden" id="videoimgC" value="<?php echo $data['resource_thumbnail']?>">
            ...
            <div class="yx_djsc">
                ...
                <div class="c_p_img_sc fl" id="sy_upimg_positionC">
                    <div class="sc_sucai" <?php if($data['examine_status']>0){echo "style=\"display: none\"";}?>>
                        ...
                        <!--<p class="sc_scsm">素材上传-图片格式为JPG,JPEG,PNG 分辨率1560*135</p>-->
                    </div>
                    <div class="sy_upimg_position" <?php if($data['examine_status']>0){echo "style=\"display: block\"";}?>>
                        <p class="bdspingmc">
                            <input id="videoNamec" class="img_name" type="text" value="<?php echo $data['resource_name']?>">
                        </p>
...
<script>
    $('.yx_tjcq').click(function(){
        ...
        var videoUrl=$('#videoUrlC').val();
        var videoimg=$('#videoimgC').val();
        var videoName=$('#videoNameC').val();
        ...
        $.ajax({
            ...
            type:"get",
            dataType:"json",
            data:{videoSha1:videoSha1,videoSize:videoSize,orderid:orderid,resource:videoUrl,resource_name:videoName,video_id:videofileId,copyright:copyright,resourcetype:resourcetype,videoimg:videoimg,duration:duration},
            success:function(data) {
                console.log(data);
                if(data.status==200){
