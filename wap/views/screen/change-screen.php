...
<div class="sy-newunchecked" style="display: none;">
    <form id="idform">
        ...
        <div class="content">
            ...
            <div class="sy-newuploadimg" style="padding-top: 15px;">
                <?if(!$operate || $operate == 1):?>
                    <p class="tit">请上传安装完成后的LED屏幕照片并填写设备编号</p>
                <?elseif ($operate == 2):?>
                    <p class="tit">更换新设备和安装照片</p>
                <?elseif ($operate == 4):?>
...
//                    var tablehtml=" <table>";
//                    if(data.data.team.team.length>0){
//                        tablehtml=tablehtml+"<tr>" +
//                        "<td>组长</td> " +
//                        "<td>"+data.data.team.team.team_member_name+"</td>" +
//                        "</tr>" +
//                        "<tr>" +
//                        "<td>手机号</td>" +
//                        "<td>"+data.data.team.team.mobile+"</td>" +
//                        "</tr>";
//                    }
//                    tablehtml=tablehtml+" <tr> " +
//                    "<td>安装人姓名</td> " +
//                    "<td id='install_name'>"+data.data.team.t_member.name+"</td> " +
//                    "</tr> " +
//                    "<tr> " +
//                    "<td>手机号</td> " +
//                    "<td id='install_mobile'>"+data.data.team.t_member.mobile+"</td> " +
//                    "</tr> " +
//                    "</table>";
//                    $(".sy_onecont_list").html(tablehtml);
                    ...
                    $.each(data.data.shopData,function(i,value){
                        ...
                        if (/iphone|ipad|ipod/.test(ua)) {
                            ...
                            "<div class='sy_imgwraper'> " +
                            "<div class='upload' id='screen"+value.id+"'> " +
                            "<input class='update_input' id='panorama"+value.id+"' type='hidden' placeholder='请上传屏幕安装图' nullmsg='panorama_image' datatype='*' value='11212.jpg'>"+
                            "<img class='imgspace' src='/static/images/newuploadimgspacing.png'> " +
                            "<img class='addimg' src='/static/images/newuploadimg-add.png' > " +
...
//	  tiptype:3,
        ...
        beforeSubmit:function(curform){
            ...
            if(judedata==0){
                ...
                $.ajax({
                    url:baseApiUrl+"/screen-change/change-post",
                    type:"POST",
                    dataType:"json",
                    data:{
                        id:<?=$shopid?>,
