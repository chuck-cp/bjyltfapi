...
<div id="infoshow" style="">
    <div class="yx_shenghenr" style="    border-top: 10px solid #f2f2f2;">
        ...
        <div class="yx_sh_lb">
            ...
            <p class="rl_nr" id="mirror_account"><span id="mirror_account"></span>面</p>
        </div>
        <div class="yx_sh_lb" style="border-bottom-width:10px;">
...
<script type="text/javascript" src="/static/js/picHideShow.js?v=20190516"></script>
<script>
        ...
        $.ajax({
            ...
            success:function(data) {
                if(data.status==200 && data.data!=null){
                    ...
                    $("#bigpic img").attr('src',data.data.panorama_image+"?imageView2/0/w/"+pageWidth());
