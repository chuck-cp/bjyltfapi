...
<script>
    ...
    $(function(){
        $.ajax({
            url:baseApiUrl+"/screeninstall/number/<?=$shopid?>?token=<?=$token?>",
            type:"get",
            dataType:"json",
        ...
        beforeSubmit:function(curform){
            ...
            if(judedata==0){
                ...
                $.ajax({
                    ...
                    type:"post",
                    dataType:"json",
                    data:{id:<?=$shopid?>,install_name:install_name,install_mobile:install_mobile,install_images:install_images,token:'<?=$token?>',isupdate:false},
                    success:function(data) {
                        //console.log(data);
                        if(data.status==200){
