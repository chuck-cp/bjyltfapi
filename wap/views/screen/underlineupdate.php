...
//	  tiptype:3,
        ...
        beforeSubmit:function(curform){
            ...
            $.ajax({
                ...
                type:"post",
                dataType:"json",
                data:{id:<?=$shopid?>,install_name:install_name,install_mobile:install_mobile,install_images:install_images,verify:verify,token:'<?=$token?>',isupdate:'<?=$isupdate?>'},
                success:function(data) {
                    if(data.status==200){
