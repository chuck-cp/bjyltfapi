...
<script>
    ...
    $(function(){
        $.ajax({
            url:baseApiUrl+"/member/recordinfo",
            type:"get",
            dataType:"json",
            data:{id:<?=$shopid?>,token:'<?=$token?>',wechat_id:<?=$wechat_id?>},
            success:function(data) {
                ...
                if(data.status==200&&data.data!=null){
                    ...
                    tippanel();
                    setTimeout(function() {    location.href="/wechat/record" },1000);
                }
            }
        });
        $(".sy-feedback-btn").click(function (){
            location.href="/wechat/record";
        })
    });
