...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/static/css/reset.css?v=1.0"/>
    <link rel="stylesheet" type="text/css" href="/static/css/logo_install.css?v=20180829"/>
    ...
    <style>
        ...
        /*安装地址样式补充*/
        .yx_srnr_dqu{ width:100%; height:15px;color:#333; border:none; padding-top: 5px;}
    ...
    <div class="yx_spxx">
        <form id="idform">
            ...
            <dl style="padding-top: 3px">
                <dt>法人代表</dt>
                <dd><input id="apply_name" autocomplete="off" class="yx_srnr" nullmsg="nameblank" type="text" datatype="*" placeholder="填写法人代表及其代理人姓名" value="<?=Html::encode($shopApplyObj->apply_name)?>" readonly="readonly" unselectable="on" onfocus="this.blur()"></dd>
            </dl>
            <dl>
                <dt>身份证号码</dt>
                <dd><input maxlength="18" id="identity_card_num" autocomplete="off" class="yx_srnr" type="text" nullmsg="idblank" datatype="IDcard" errormsg="errorid" placeholder="请填写申请人身份证号码" value="<?=Html::encode($shopApplyObj->identity_card_num)?>" readonly="readonly" unselectable="on" onfocus="this.blur()"></dd>
            </dl>
            <dl>
                <dt>手机号码</dt>
                <dd>
                    <?if($type == 'dianpu'):?>
                        <input oninput="if(value.length>11)value=value.slice(0,5)" id="apply_mobile" autocomplete="off" value="<?=Html::encode($shopApplyObj->apply_mobile)?>" readonly="readonly" unselectable="on" onfocus="this.blur()" class="yx_srnr" type="number" nullmsg="numbphone" datatype="phone" errormsg="errorphone" placeholder="请填写申请人手机号码">
                    <?else:?>
                        <input oninput="if(value.length>11)value=value.slice(0,5)" id="apply_mobile" autocomplete="off" class="yx_srnr" type="number" nullmsg="numbphone" datatype="phone" errormsg="errorphone" placeholder="请填写申请人手机号码" value="<?=Html::encode($shopApplyObj->apply_mobile)?>" readonly="readonly" unselectable="on" onfocus="this.blur()">
                    <?endif?>
                </dd>
            </dl>
<!--            <dl class="yx-sendyzm">-->
<!--                <dt>验证码</dt>-->
<!--                <dd><input maxlength="6" id="verify" autocomplete="off" class="yx_srnr" type="number" placeholder="输入验证码" nullmsg="numbyzm" datatype="*" errormsg="numbcorrect" ></dd>-->
...
<!--            </dl>-->
            ...
            <dl class="yx-sendyzm">
                <dt>店铺联系人</dt>
                <dd><input id="contacts_name" autocomplete="off" class="yx_srnr" type="text" value="<?=Html::encode($shopApplyObj->contacts_name)?>" placeholder="填写店铺联系人姓名" nullmsg="contacts_name"></dd>
            </dl>
            <dl class="yx-sendyzm">
                <dt>联系人手机</dt>
                <dd><input oninput="if(value.length>11)value=value.slice(0,5)" id="contacts_mobile" autocomplete="off" class="yx_srnr" type="number" value="<?=Html::encode($shopApplyObj->contacts_mobile)?>" placeholder="店铺联系人手机号" nullmsg="contacts_mobile" datatype="phone"></dd>
            </dl>
            <!--店铺信息--->
            <h5>店铺信息</h5>
            <dl>
                <dt>公司名称</dt>
                <dd><input id="company_name" autocomplete="off" class="yx_srnr" type="text" placeholder="请输入公司名称" nullmsg="companyname" datatype="*" value="<?=Html::encode($shopApplyObj->company_name)?>" readonly="readonly" unselectable="on" onfocus="this.blur()"></dd>
            </dl>
            <dl>
                <dt>店铺名称</dt>
                <dd><input id="name" autocomplete="off" class="yx_srnr" type="text" placeholder="请输入店铺名称" nullmsg="shopname" datatype="*" value="<?=Html::encode($shopObj->name)?>" readonly="readonly" unselectable="on" onfocus="this.blur()"></dd>
            </dl>
            <dl class="sy_smallscreen">
                <dt>统一社会信用代码</dt>
                <dd><input id="registration_mark" autocomplete="off" class="yx_srnr" type="text" placeholder="请输入营业执照统一社会信用代码" nullmsg="busneyzm" datatype="*" value="<?=Html::encode($shopApplyObj->registration_mark)?>" readonly="readonly" unselectable="on" onfocus="this.blur()"></dd>
            </dl>
            <dl class="yx_anzdz">
                <dt>安装地址</dt>
                <dd>
                    <p class="yx_dzxq" id="azdz">
                        <input type="hidden" id="area" placeholder="请选择地区" nullmsg="installarea" datatype="*" value="<?=Html::encode($shopObj->area)?>">
                        <cite id="area_name" class="yx_srnr_dqu"><?=Html::encode($shopObj->area_name)?></cite>
                    </p>
                    <p class="yx_dzxq" id="xxdz"><input autocomplete="off" id="address" class="yx_srnr" type="text" placeholder="请填写详细地址" nullmsg="installaddress" datatype="*" value="<?=Html::encode($shopObj->address)?>" readonly="readonly" unselectable="on" onfocus="this.blur()"></p>
                </dd>
            </dl>
            <dl class="yx_dpxx">
                <dt>店铺面积</dt>
                <dd><input id="acreage" autocomplete="off" class="yx_srnr" type="number" placeholder="请填写店铺面积" nullmsg="shoparea" datatype="*" value="<?=Html::encode($shopObj->acreage)?>"></dd>
                <cite>平米</cite>
            </dl>
            <dl class="yx_dpxx">
                <dt>安装数量</dt>
                <dd><input id="apply_screen_number" errormsg="error_apply_screen_number" autocomplete="off"  datatype="j_cont" class="yx_srnr" type="number" placeholder="请填写安装数量" nullmsg="shopnumber" datatype="*" value="<?=Html::encode($shopObj->apply_screen_number)?>"></dd>
                <cite>台</cite>
            </dl>
            <dl class="yx_dpxx">
                <dt>镜面数量</dt>
                <dd><input id="mirror_account" errormsg="error_mirror_account" autocomplete="off" class="yx_srnr" datatype="j_cont"  type="number" placeholder="请填写镜面数量" nullmsg="mirrornum" datatype="*" value="<?=Html::encode($shopObj->mirror_account)?>"></dd>
                <cite>面</cite>
            </dl>
            <dl class="yx_dpxx sy_scream_dpxx">
                ...
                <dd class="sy_selecttime">                	
                    <p class="sy_setline">
                        <span><em class="business-open" id="screen_start_at"><?=$shopApplyObj->screen_start_at?></em></span>请自定义选择屏幕开机时间
                    </p>                  		
                </dd>
            </dl>
            <dl class="yx_dpxx sy_scream_dpxx">
                <dt>设备关机时间</dt>
                <dd class="zhj_selecttime">
                    ...
                    <p class="sy_setline">
                    	<span><em class="business-close" id="screen_end_at"><?=Html::encode($shopApplyObj->screen_end_at)?></em></span>屏幕开机时间不得小于12小时
                    </p>
                </dd>
            </dl>                      
            <!--上传照片--->
                ...
                <div class="yx_sc_img">
                    ...
                    <div class="yx_sc_img">
                        ...
                        <div class="upload" id="upload1">
                            <input id="identity_card_front" class="update_input" type="hidden" placeholder="请上传法人身份证正面照" nullmsg="identity_card_front" datatype="*" value="<?=Html::encode($shopApplyObj->identity_card_front)?>">
                            <img class="imgspace" src="/static/image/blank.jpg">
                            <img class="addimg" src="<?=Html::encode($shopApplyObj->identity_card_front)?>">
...
<!--                            <div class="progress-bar" step="0"></div>-->
                        ...
                        <div class="upload" id="upload2">
                            <input id="identity_card_back" class="update_input" type="hidden" placeholder="请上传法人身份证背面照" nullmsg="identity_card_back" datatype="*" value="<?=Html::encode($shopApplyObj->identity_card_back)?>">
                            <img class="imgspace" src="/static/image/blank.jpg">
                            <img class="addimg" src="<?=Html::encode($shopApplyObj->identity_card_back)?>">
...
<!--                            <div class="progress-bar" step="0"></div>-->
                    ...
                    <div class="yx_sc_img">
                        <p class="yx_scbt">店铺联系人(选填):</p>
                        <div class="upload" id="upload3">
                            <input id="agent_identity_card_front" class="update_input" type="hidden" placeholder="请上传代理人身份证正面照" value="<?=Html::encode($shopApplyObj->agent_identity_card_front)?>">
                            <img class="imgspace" src="/static/image/blank.jpg">
                            <img class="addimg" <?if($shopApplyObj->agent_identity_card_front):?>src="<?=Html::encode($shopApplyObj->agent_identity_card_front)?>"<?else:?>src="/static/image/uploadimg-add.png"<?endif;?>>
                            <p class="idcardzfti">身份证正面</p>
                            <?if ($dev == 'ios'):?>
                        ...
                        <div class="upload" id="upload4">
                            <input id="agent_identity_card_back" class="update_input" type="hidden" placeholder="请上传代理人身份证背面照" value="<?=Html::encode($shopApplyObj->agent_identity_card_back)?>">
                            <img class="imgspace" src="/static/image/blank.jpg">
                            <img class="addimg" <?if($shopApplyObj->agent_identity_card_back):?>src="<?=Html::encode($shopApplyObj->agent_identity_card_back)?>"<?else:?>src="/static/image/uploadimg-add.png"<?endif;?>>
                            <p class="idcardzfti">身份证反面</p>
                            <?if ($dev == 'ios'):?>
                    ...
                    <div class="yx_sc_img">
                        ...
                        <div>
                            <div class="upload" id="screen5">
                                <input id="business_licence" class="update_input" type="hidden" placeholder="请上传营业执照图片" nullmsg="business_licence" datatype="*" value="<?=Html::encode($shopApplyObj->business_licence)?>">
                                <img class="imgspace" src="/static/image/blank.jpg">
                                <img class="addimg" src="<?=Html::encode($shopApplyObj->business_licence)?>">
<!--                                --><?//if ($dev == 'ios'):?>
...
<!--                                <div class="progress-bar" step="0"></div>-->
                    ...
                    <div class="yx_sc_img">
                        ...
                        <div>
                            <div class="upload" id="screen6">
                                <input id="shop_image" class="update_input" type="hidden" placeholder="请上传店铺门脸照" nullmsg="shop_image" datatype="*" value="<?=Html::encode($shopObj->shop_image)?>">
                                <img class="imgspace" src="/static/image/blank.jpg">
                                <img class="addimg" src="<?=Html::encode($shopObj->shop_image)?>">
                                <?if ($dev == 'ios'):?>
                    ...
                    <div class="yx_sc_img">
                        ...
                        <div>
                            <div class="upload" id="screen7">
                                <input class="update_input" id="panorama_image" type="hidden" placeholder="请上传室内全景" nullmsg="panorama_image" datatype="*" value="<?=Html::encode($shopApplyObj->panorama_image)?>">
                                <img class="imgspace" src="/static/image/blank.jpg">
                                <img class="addimg" src="<?=Html::encode($shopApplyObj->panorama_image)?>">
                                <?if ($dev == 'ios'):?>
                ...
                <?if($shopObj->shop_operate_type == 1):?>
                <div class="yx_sc_img">
                    <p class="yx_scbt">请上传授权证明,最多填写五张 </p>
                    <div class="sy_authorcertif">
                        <?$authorize_image = explode(",",$shopApplyObj->authorize_image);
                        $idStart = 8;
                        foreach($authorize_image as $key=>$value):?>
                        <div class="upload" id="screen<?=$idStart+$key?>">
                            <input class="update_input" id="authoriz_image<?=$key++?>" type="hidden" placeholder="请上传授权证明图片" nullmsg="authoriz_image" datatype="*" value="<?=$value?>">
                            <img class="imgspace" src="/static/image/blank.jpg">
                            <img class="addimg" src="<?=$value?>">
                            <?if ($dev == 'ios'):?>
                                <p class="Upload-imginput" id="up<?=$idStart+$key?>"></p>
                            <? else:?>
                                <input type="file" class="Upload-imginput" accept="image/*" id="up<?=$idStart+$key?>">
                            <?endif;?>
                            <div class="progress-bar" step="0"></div>
                            <p class="syred_upload_pic"><img src="/static/image/sy_sqfdreducs.png"></p>
                        </div>
                        <?endforeach;
                        if(count($authorize_image) < 5):?>
                        <p class="syadd_upload_pic" name="auth_upload_image">
                        	<img class="imgspace" src="/static/image/blank.jpg">
                ...
                <div class="yx_sc_img">
                    ...
                    <div id="upload_other_image" class="sy_authorcertif">
                        <div class="upload" id="screen14" style="display: none">
                            <input class="update_input" id="other_image1" type="hidden">
                            <img class="imgspace" src="/static/image/blank.jpg">
                            <img class="addimg" src="/static/image/uploadimg-add.png">
                            <?if ($dev == 'ios'):?>
                                <p class="Upload-imginput" id="up14"></p>
                            <? else:?>
                                <input type="file" class="Upload-imginput" accept="image/*" id="up14">
                            <?endif;?>
                            <div class="progress-bar" step="0"></div>
                        </div>
                        <?$other_image = explode(",",$shopApplyObj->other_image);
                        $idStart = 15;
                        foreach($other_image as $key=>$value):?>
                        <div class="upload" id="screen<?=$idStart+$key?>">
                            <input class="update_input" id="other_image<?=$key+1?>" type="hidden" value="<?=$value?>">
                            <img class="imgspace" src="/static/image/blank.jpg">
                            <img class="addimg" src="<?=empty($value) ? "/static/image/uploadimg-add.png" : $value?>">
                            <?if ($dev == 'ios'):?>
                                <p class="Upload-imginput" id="up<?=$idStart+$key?>"></p>
                            <? else:?>
                                <input type="file" class="Upload-imginput" accept="image/*" id="up<?=$idStart+$key?>">
...
<!--                <input type="hidden" id="apply_brokerage" value="--><?//=Html::encode($shopApplyObj->apply_brokerage)?><!--" name="apply_brokerage" nullmsg="apply_brokerage" datatype="*">-->
                <input type="hidden" id="apply_brokerage_token" name="apply_brokerage_token" nullmsg="apply_brokerage_token" datatype="*" value="<?=Html::encode($apply_brokerage_token)?>">
    ...
    <div class="sy_install_protocol">
        <div class="sy_con_scroll">
            ...
            <div class="content">
                <span class="apply_brokerage_price" id="month_price" style="display: none"><?=$shopApplyObj->apply_brokerage_by_month?></span>
                <span class="apply_brokerage_price" id="apply_brokerage_price" style="display:none "><?=$apply_brokerage?></span>
    ...
    <script type="text/javascript" src="/static/js/img-upload.js?v=2.0"></script>
    <script type="text/javascript" src="/static/js/jquery.area.js?v=1.9"></script>
        ...
        $('.syadd_upload_pic').click(function(){
            ...
            if(inputleg<6){
                if($(this).attr('name') == 'other_upload_image'){
                    ...
                    var inputHtml = '<input class="update_input" id="'+newupdate_inputid+'" type="hidden" placeholder="请上传授权证明图片" nullmsg="authoriz_image">';
                }
...
//                };
                ...
                if(msg=='authoriz_image'){
                    $('.sy-installed-ts').text('请上传授权证明图片');
                    tippanel();
                };
                if(msg=='contacts_name'){
                    $('.sy-installed-ts').text('店铺联系人姓名不能为空');
                    tippanel();
                };
                if(msg=='contacts_mobile'){
                    $('.sy-installed-ts').text('店铺联系人手机号不能为空');
                    tippanel();
                };
            },
...
//                    type: "GET",
//                    async: false,
//                    url: baseApiUrl+"/system/brokerage?area_id="+area_id+'&screen_number='+$('#mirror_account').val(),
...
//            })
        ...
        $('.sy_install_btn button:last-child').click(function(){
            zztj();
            var shop_operate_type = '<?=$shopObj->shop_operate_type?>';
            var authorize_image = '';
            $(".sy_authorcertif input[class='update_input']").each(function(){
                if(authorize_image == ''){
                    authorize_image = $(this).val();
                }else{
                    authorize_image = authorize_image + ',' + $(this).val();
                }
            });
            var  other_image = '';
            $("#upload_other_image .update_input").each(function(){
                if($(this).val() != ''){
                    if(other_image == ''){
                        other_image = $(this).val();
                    }else{
                        other_image = other_image + ',' + $(this).val();
                    }
                }
            });
            var postShop = {
                ...
                'contacts_mobile':$('#contacts_mobile').val(),
                ...
                'area':$('#area').val(),
                'address':$('#address').val(),
                'apply_brokerage':$('#apply_brokerage_price').html()*100,
                ...
                'screen_end_at':$('#screen_end_at').html(),
                'apply_brokerage_by_month':parseInt($('#month_price').html())*100,
                'shop_operate_type':shop_operate_type,
                'authorize_image':authorize_image,
                'other_image':other_image
            };
            $.ajax({
                type: "POST",
                data: postShop,
                url: baseApiUrl+"/shop/"+"<?=$shopObj->id?>"+"/modify?token=<?=$token?>&wechat_id=<?=$wechat_id?>",
                success:function(data){
                    var type = "<?=Html::encode($type)?>";
                    if(data.status == 200){
                        var shop_id = data.data.shop_id;
                        //跳转
                        if(data.data.types == 'weixin'){
                            alert('修改成功');
                            window.location.href = "/wechat/record?token=<?=$token?>";
                        }else{
                            //window.location.href = "<?=\yii\helpers\Url::to(['success'])?>"+"?shopid="+shop_id+"&modify=modify&token="+"<?=$token?>";
                            $('#zztj').hide();
                            $('.zztj_zz').hide();
                            $('.sy_install_protocol').hide();
                            $('.sy_dzmask').show();
