...
<div>
    <div class="yx_spxx">
        <form id="idform">
            ...
            <dl style="padding-top: 3px">
                <dt>法人代表</dt>
                <dd><input id="apply_name" autocomplete="off" class="yx_srnr" nullmsg="nameblank" type="text" datatype="*" placeholder="填写法人代表及其代理人姓名" value="<?=Html::encode($shopApplyObj->apply_name)?>"></dd>
            </dl>
            <dl>
                <dt>身份证号码</dt>
                <dd><input maxlength="18" id="identity_card_num" autocomplete="off" class="yx_srnr" type="text" nullmsg="idblank" datatype="IDcard" errormsg="errorid" placeholder="请填写申请人身份证号码" value="<?=Html::encode($shopApplyObj->identity_card_num)?>"></dd>
            </dl>
            <dl>
                <dt>手机号码</dt>
                <dd>
            ...
            <dl class="yx-sendyzm">
                <dt>店铺联系人</dt>
                <dd><input id="contacts_name" autocomplete="off" class="yx_srnr" type="text" value="<?=Html::encode($shopApplyObj->contacts_name)?>" placeholder="填写店铺联系人姓名" nullmsg="contacts_name" datatype="*"></dd>
            </dl>
            <dl class="yx-sendyzm">
                <dt>手机</dt>
            ...
            <dl>
                <dt>公司名称</dt>
                <dd><input id="company_name" autocomplete="off" class="yx_srnr" type="text" placeholder="请输入公司名称" nullmsg="companyname" datatype="*" value="<?=Html::encode($shopApplyObj->company_name)?>"></dd>
            </dl>
            <dl>
                <dt>店铺名称</dt>
                <dd><input id="name" autocomplete="off" class="yx_srnr" type="text" placeholder="请输入店铺名称" nullmsg="shopname" datatype="*" value="<?=Html::encode($shopObj->name)?>"></dd>
            </dl>
            <dl class="sy_smallscreen">
                <dt>统一社会信用代码</dt>
                <dd><input id="registration_mark" autocomplete="off" class="yx_srnr" type="text" placeholder="请输入营业执照统一社会信用代码" nullmsg="busneyzm" datatype="*" value="<?=Html::encode($shopApplyObj->registration_mark)?>"></dd>
            </dl>
            <dl class="yx_anzdz">
                <dt>安装地址</dt>
                <dd>
                    ...
                    <p class="yx_dzxq" id="xxdz"><input autocomplete="off" id="address" class="yx_srnr" type="text" placeholder="请填写详细地址" nullmsg="installaddress" datatype="*" value="<?=Html::encode($shopObj->address)?>"></p>
                </dd>
            </dl>
            <dl class="yx_dpxx">
                <dt>店铺面积</dt>
            ...
            <dl class="yx_dpxx sy_scream_dpxx">
                ...
                <dd class="zhj_selecttime">
                    ...
                    <p class="sy_setline">
                    	<span><em class="business-close" id="screen_end_at"><?=Html::encode($shopApplyObj->screen_end_at)?></em></span>屏幕开机时间不得小于10小时
                    </p>
                </dd>
            </dl>                      
            <!--上传照片--->
            ...
            <div class="yx_shangc">
                ...
                <div class="yx_sc_img">
                    ...
                    <div id="upload_auth_image" class="sy_authorcertif">
                        <div class="upload" id="screen8" style="display: none">
                            <input class="update_input" id="other_image1" type="hidden">
                            <img class="imgspace" src="/static/image/blank.jpg">
                            <img class="addimg" src="/static/image/uploadimg-add.png">
                            <?if ($dev == 'ios'):?>
                                <p class="Upload-imginput" id="up8"></p>
                            <? else:?>
                                <input type="file" class="Upload-imginput" accept="image/*" id="up8">
                            <?endif;?>
                            <div class="progress-bar" step="0"></div>
                        </div>
    ...
    <div class="sy_install_protocol">
        <div class="sy_con_scroll">
            ...
            <div class="content">
                <span class="apply_brokerage_price" id="month_price" style="display: none"><?=($shopApplyObj->apply_brokerage_by_month/100)?></span>
...
//            })
        ...
        $('.sy_install_btn button:last-child').click(function(){
            zztj();
            var authorize_image = '';
            $("#upload_auth_image input[class='update_input']").each(function(){
                if(authorize_image == ''){
            ...
            var other_image = '';
            $("#upload_other_image input[class='update_input']").each(function(){
                if($(this).val() != ''){
                    if(other_image == ''){
