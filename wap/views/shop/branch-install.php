...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/static/css/logo_install.css?v=2018091800"/>
...
<div>
    <div class="yx_spxx">
        <form id="idform">
            ...
            <dl>
                <dt>法人代表</dt>
                <dd><input id="apply_name" autocomplete="off" class="yx_srnr" nullmsg="nameblank" type="text" datatype="*" placeholder="填写法人代表姓名" readonly="readonly" unselectable="on" onfocus="this.blur()"></dd>
            </dl>
            <dl>
                <dt>身份证号码</dt>
                <dd><input maxlength="18" id="identity_card_num" autocomplete="off" class="yx_srnr" type="text" nullmsg="idblank" datatype="IDcard" errormsg="errorid" placeholder="请填写申请人身份证号码" readonly="readonly" unselectable="on" onfocus="this.blur()"></dd>
            </dl>
            <dl>
                <dt>手机号码</dt>
                <dd>
                    <?if($type == 'dianpu' && !empty($mobile)):?>
                        <input oninput="if(value.length>11)value=value.slice(0,5)" id="apply_mobile" autocomplete="off" value="<?=$mobile?>" readonly="readonly" unselectable="on" onfocus="this.blur()" class="yx_srnr"  type="number" nullmsg="numbphone" datatype="phone" errormsg="errorphone" placeholder="请填写申请人手机号码" >
                    <?else:?>
                        <input oninput="if(value.length>11)value=value.slice(0,5)" id="apply_mobile" autocomplete="off" class="yx_srnr" type="number" nullmsg="numbphone" datatype="phone" readonly="readonly" unselectable="on" onfocus="this.blur()" errormsg="errorphone" placeholder="请填写申请人手机号码" >
                    <?endif?>
                </dd>
            </dl>
<!--            <dl class="yx-sendyzm">-->
...
<!--            </dl>-->
            ...
            <dl>
                <dt>店铺联系人</dt>
                <dd>
                    <input id="contacts_name" autocomplete="off" class="yx_srnr" nullmsg="nameblank" type="text" datatype="*" placeholder="请填写店铺联系人姓名" >
                </dd>
            </dl>
            <dl>
                <dt>手机号</dt>
                <dd><input oninput="if(value.length>11)value=value.slice(0,5)"  id="contacts_mobile" autocomplete="off" class="yx_srnr" type="number" nullmsg="applyphone" datatype="phone" errormsg="errorphone" placeholder="请填写联系人手机号"></dd>
            </dl>
            <!--店铺信息--->			
            <h5>店铺信息</h5>
            <dl>
                <dt>公司名称</dt>
                <dd><input id="company_name" autocomplete="off" class="yx_srnr" type="text" placeholder="请输入公司名称" nullmsg="companyname" datatype="*" readonly="readonly" unselectable="on" onfocus="this.blur()"></dd>
            </dl>
            <dl>
                <dt>店铺名称</dt>
                <dd><input id="name" autocomplete="off" class="yx_srnr" type="text" placeholder="请输入店铺名称" nullmsg="shopname" datatype="*" readonly="readonly" unselectable="on" onfocus="this.blur()"></dd>
            </dl>
            <dl class="sy_smallscreen">
                <dt>统一社会信用代码</dt>
                <dd><input id="registration_mark" autocomplete="off" class="yx_srnr" type="text" placeholder="请输入营业执照统一社会信用代码" nullmsg="busneyzm" datatype="*" readonly="readonly" unselectable="on" onfocus="this.blur()"></dd>
            </dl>
            <dl class="yx_anzdz">
                <dt>安装地址</dt>
                <dd>
                    <p class="yx_dzxq" id="azdz">
                        ...
                        <cite id="area_name" class="yx_srnr_dqu" style="color: #333;">请选择地区</cite>
                    </p>
                    <p class="yx_dzxq" id="xxdz"><input autocomplete="off" id="address" class="yx_srnr" type="text" placeholder="请填写详细地址" nullmsg="installaddress" readonly="readonly" unselectable="on" onfocus="this.blur()" datatype="*"></p>
                </dd>
            </dl>
            <dl class="yx_dpxx">
                <dt>店铺面积</dt>
            ...
            <dl class="yx_dpxx sy_scream_dpxx">
                ...
                <dd class="sy_selecttime">
                    	<!--<input id="screen_start_at" errormsg="error_screen_start_at" autocomplete="off" class="yx_srnr" datatype="j_cont"   placeholder="请填写设备开机时间" nullmsg="mirrornum" datatype="*" value="10:00:00">-->
                        <p class="sy_setline">
            ...
            <dl class="yx_dpxx sy_scream_dpxx">
                ...
                <dd class="zhj_selecttime">
                    ...
                    <p class="sy_setline">
                        	<span><em class="business-close test" id="screen_end_at">22:00</em></span>请自定义选择屏幕关机时间
                    </p>
                </dd>
            </dl>			
            <!--上传照片--->
...
<!--                                --><?//endif;?>
                ...
                <input type="hidden" id="apply_brokerage_token" name="apply_brokerage_token" nullmsg="apply_brokerage_token" datatype="*" value="0">
    ...
    <div id="tip"  style="width: 80%;text-align: center;position: fixed; top: 30%; left: 10%;z-index: 100;display: none">
        <p style="font-weight: bold;font-size: 16px;color: #ff7d09;padding: 44px 0;background: #fff;border-radius: 10px 10px 0 0;">安装申请提交成功！</p>
    ...
    <script>
        ...
        /************************************/
        $.ajax({
            url:baseApiUrl+'/shop-head/get-subbranch-info/'+'<?=$head_id?>'+'/branch/<?=$branch_id?>'+'?token='+'<?=$token?>',
            type:'GET',
            async:true,
            success:function (data) {
                //console.log(data);
                $('#apply_name').val(data.data.name);
                $('#identity_card_num').val(data.data.identity_card_num);
                $('#apply_mobile').val(data.data.mobile);
                $('#company_name').val(data.data.company_name);
                $('#registration_mark').val(data.data.registration_mark);
                $('#upload1 .addimg').attr('src',data.data.identity_card_front);
                $('#identity_card_front').val(data.data.identity_card_front);
                $('#upload2 .addimg').attr('src',data.data.identity_card_back);
                $('#identity_card_back').val(data.data.identity_card_back);
                $('#screen5 .addimg').attr('src',data.data.business_licence);
                $('#business_licence').val(data.data.business_licence);
                $('#area').val(data.data.branch_shop_area_id);
                $('#area_name').html(data.data.branch_shop_area_name);
                $('#name').val(data.data.branch_shop_name);
                $('#address').val(data.data.branch_shop_address);
                //$('#apply_brokerage_price').html(data.data.by_year/100);
                $('#month_price').html(data.data.by_month/100);
                $('#apply_brokerage').val(data.data.by_year);
                $('#apply_brokerage_token').val(data.data.price_token)
            },error:function (data) {
        ...
        $("#idform").Validform({
            ...
            tiptype:function(msg,o,cssctl){
                if(msg=='nameblank'){
                    $('.sy-installed-ts').text('店铺联系人不能为空');
                    tippanel();
                };
                if(msg=='idblank'){
                ...
                if(msg=='applyphone'){
                    $('.sy-installed-ts').text('联系人手机号不能为空');
                    tippanel();
                };
...
//                };
        ...
        $('.sy_install_btn button:last-child').click(function(){
            ...
            var postShop = {
                ...
                'headquarters_list_id':'<?=$branch_id?>',
                'shop_operate_type':3,
                //店铺联系人姓名电话
            ...
            $.ajax({
                type: "POST",
                data: postShop,
                url: baseApiUrl+"/shop/inner-create?token=<?=$token?>&wechat_id=<?=$wechat_id?>",
                success:function(data){
                    if(data.status == 200){
                        //跳转
//                        var shop_id = data.data.shop_id;
//                        window.location.href = "<?//=\yii\helpers\Url::to(['success'])?>//"+"?shopid="+shop_id+"&token="+"<?//=$token?>//";
                        $('#zztj').hide();
                        $('.zztj_zz').hide();
                        $('.sy_install_protocol').hide();
                        $('.sy_dzmask').show();
