...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/static/css/logo_install.css?v=20180911"/>
        ...
        <form id="idform">
            ...
            <dl>
                ...
                <dd>
                    ...
                    <?else:?>
                        <input oninput="if(value.length>11)value=value.slice(0,5)" id="apply_mobile" autocomplete="off" class="yx_srnr" type="number" nullmsg="numbphone" datatype="phone" errormsg="errorphone" placeholder="请填写申请人手机号码" >
                    <?endif?>
                </dd>
            </dl>
            <dl class="yx-sendyzm">
            ...
            <?if($type == 'yewu' && !empty($mobile)):?>
                ...
                <!--                        <dd><input oninput="if(value.length>11)value=value.slice(0,5)" id="member_mobile" autocomplete="off" readonly="readonly" class="yx_srnr" type="text" value="--><?//=$mobile?><!--" placeholder="填写业务员手机号" nullmsg="numbzsxm" datatype="phone"></dd>-->
                <!--                    </dl>-->
            <?else:?>
                <!--                    <dl class="tuijianren">-->
                <!--                        <dt><span>联系人/</span><span>业务合作人</span></dt>-->
                <!--                        <dd><input oninput="if(value.length>11)value=value.slice(0,5)" id="member_mobile" autocomplete="off" class="yx_srnr" type="text" placeholder="填写联系人/业务合作人手机号"></dd>-->
                <!--                    </dl>-->
            <?endif?>
            <!--店铺信息--->
            <h5>公司信息</h5>
            ...
            <dl class="yx_anzdz">
                ...
                <dd>
                    <p class="yx_dzxq azdz" >
                        ...
                        <cite id="gongsi_dz" class="yx_srnr_dqu ">请选择地区</cite>
                    </p>
                        ...
                        <dl class="yx_anzdz">
                            ...
                            <dd>
                                <p class="yx_dzxq azdz">
                                    ...
                                    <cite  class="yx_srnr_dqu">请选择地区</cite>
                                </p>
...
<!--    <script type="text/javascript" src="/static/js/jquery.area.js?v=1.6"></script>-->
    ...
    <script>
        ...
        $('.sy_addspan_red').live('click',function () {
            ...
            if(nu == -1){
                $(this).parents('.each').prev('.each').find('dl:first dd').append('<span class="sy_addspan"><img src="/static/image/sy_sqfdadd.png"></span>');
            }
        ...
        $('.sy_install_btn button:last-child').click(function(){
            ...
            $('.branch .br_area_id').each(function () {
                var shopArea = $(this).val();
                pushArr(branchArea,shopArea);
            })
            //分店详细地址
            $('.branch .yx_srnr').each(function () {
                var shopAddress = $(this).val();
                pushArr(branchAddress,shopAddress);
            })
            //其他图片
            ...
            $.ajax({
                type: "POST",
                data: postShop,
                url: baseApiUrl+"/shop-head/shop-head-create?token=<?=$token?>&wechat_id=<?=$wechat_id?>&dev=<?=$dev?>",
                success:function(data){
...
//                        window.location.href = "<?//=\yii\helpers\Url::to(['success'])?>//"+"?shopid="+shop_id+"&token="+"<?//=$token?>//";
        ...
        $('#achieve').on('click',function () {
            if(active_id == '') {
                ...
                window.location.href = "<?=\yii\helpers\Url::to(['/inner-install/choose'])?>"+"?&token="+"<?=$token?>"+"&dev=<?=$dev?>";
            }
        })
    </script>
</body>
