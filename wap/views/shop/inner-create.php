<!doctype html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/static/css/logo_install.css?v=20190218"/>
    ...
    <div>
        <div class="yx_spxx">
            <form id="idform">
                ...
                <dl style="padding-top: 3px">
                    <dt>法人代表</dt>
                    <dd><input id="apply_name" autocomplete="off" class="yx_srnr" nullmsg="nameblank" type="text" datatype="*" placeholder="填写法人代表及其代理人姓名" ></dd>
                </dl>
                <dl>
                    <dt>身份证号码</dt>
                ...
                <dl>
                    ...
                    <dd>
                        <?if($type == 'dianpu' && !empty($mobile)):?>
                            <input oninput="if(value.length>11)value=value.slice(0,11)" id="apply_mobile" autocomplete="off" value="<?=$mobile?>" readonly="readonly" unselectable="on" onfocus="this.blur()" class="yx_srnr" type="number" nullmsg="numbphone" datatype="phone" errormsg="errorphone" placeholder="请填写申请人手机号码" >
                        <?else:?>
                            <input oninput="if(value.length>11)value=value.slice(0,11)" id="apply_mobile" autocomplete="off" class="yx_srnr" type="number" nullmsg="numbphone" datatype="phone" errormsg="errorphone" placeholder="请填写申请人手机号码" >
                        <?endif?>
                    </dd>
                </dl>
                <dl class="yx-sendyzm">
                ...
                <dl class="yx-sendyzm">
                    <dt>店铺联系人</dt>
                    <dd><input id="contacts_name" autocomplete="off" class="yx_srnr" type="text" value="" placeholder="填写店铺联系人姓名" nullmsg="contacts_name" datatype="*"></dd>
                </dl>
                <dl class="yx-sendyzm">
                    <dt>手机</dt>
                    <dd><input oninput="if(value.length>11)value=value.slice(0,5)" id="contacts_mobile" autocomplete="off" class="yx_srnr" type="number" value="" placeholder="店铺联系人手机号" nullmsg="contacts_mobile" datatype="phone"></dd>
                </dl>
                <style>
                    .yx-sendyzm .send-yzm{
                        height: 40px;
                ...
                <dl class="yx_dpxx sy_scream_dpxx">
                    ...
                    <dd class="zhj_selecttime">
                        ...
                        <p class="sy_setline">
                        	<span><em class="business-close" id="screen_end_at">22:00</em></span>请自定义选择屏幕关机时间
                        </p>
                    </dd>
                </dl>                
                <!--上传照片--->
                    ...
                    <div class="yx_sc_img">
                        ...
                        <div class="yx_sc_img">
                            ...
                            <div id="upload_auth_image" class="sy_authorcertif">
                                ...
                                <div class="upload" id="screen9">
                                    <input class="update_input" id="authoriz_image1" type="hidden" placeholder="请上传授权证明图片" nullmsg="authoriz_image" datatype="*">
                                    <img class="imgspace" src="/static/image/blank.jpg">
                                    <img class="addimg" src="/static/image/uploadimg-add.png">
                                    <?if ($dev == 'ios'):?>
                                        <p class="Upload-imginput" id="up9"></p>
                                    <? else:?>
                                        <input type="file" class="Upload-imginput" accept="image/*" id="up9">
                                    <?endif;?>
                                    <div class="progress-bar" step="0"></div>
                                </div>
        ...
        <!--开关机结束-->                        
        <script>
            var shop_operate_type = "<?=$shop_operate_type?>";
        ...
        <script type="text/javascript" src="/static/js/select_time.js?v=20190218"></script>
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data.status == 200){
                                ...
                                //var active_id = data.data.activity_detail_id;
                                //window.location.href = "<?=\yii\helpers\Url::to(['success'])?>"+"?shopid="+shop_id+"&token="+"<?=$token?>"+"&active_id="+active_id;
                                $('#zztj').hide();
                                $('.zztj_zz').hide();
                                $('.sy_install_protocol').hide();
                                $('.sy_dzmask').show();
