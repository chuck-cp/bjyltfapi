...
<ul class="park_apple" id="list_box">
    ...
    <li>
        ...
        <div class="biz_box" >
            ...
            <div class="equipment_type" id="led_equipment">
                <img  src="/static/image/more_apply/led_equipment.png" >
            </div>
        </div>
    </li>
</ul>
...
<script type="text/javascript">
    ...
    function list_info(a,b) {
        ...
        $.each(a, function(index, value) {
            if(b == 1){
                sel_def += "<a href='/build?token="+token+"'><li>" + value + "</li></a>";
            }else if(b ==2){
                sel_def += "<a href=''><li>" + value + "</li></a>";
            }
        });
    }
