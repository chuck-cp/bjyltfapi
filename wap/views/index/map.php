...
<script type="text/javascript">
    area_id=123122
    // 百度地图API功能
    var map = new BMap.Map("l-map", {enableMapClick:false});          // 创建地图实例
    ...
    function addCustomLayer(keyword) {
        ...
        customLayer=new BMap.CustomLayer({
           // geotableId: 30960,
            ...
            q: '', //检索关键字
            tags: '', //空格分隔的多字符串
            //filter: 'area_id:0,123123' //过滤条件,参考http://lbsyun.baidu.com/lbs-geosearch.htm#.search.nearby
    ...
    function callback(e)//单击热点图层
    {
        ...
        var content = '<p style="width:280px;margin:0;line-height:20px;">店铺编号：' + contentPoi.shop_id + '<br/>地址：' + customPoi.address + '<br/>屏幕数量:'+contentPoi.screen_number+'<br/>镜面数量:'+contentPoi.mirror_account+'</p>';
