...
return [
    ...
    //修改安装屏幕
    'POST '.$from_version.'/screeninstall/change-post'=>$version.'/screeninstall/change-post',
    //屏幕安装 获取订单屏幕激活状态
    ...
    //业绩排行
    'GET '.$from_version.'/performance-rank' => $version.'/performance-rank/index',
    //我的店铺列表
    'GET '.$from_version.'/my-shop/list' => $version.'/my-shop/list',
    //我的店铺详情
    'GET '.$from_version.'/my-shop/<shop_id>' => $version.'/my-shop/detail',
