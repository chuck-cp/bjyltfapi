...
/**
 * This is the model class for table "{{%sign_team_maintain_count}}".
 *
 * @property string $id
...
class SignTeamMaintainCount extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['team_id', 'total_sign_member_number', 'overtime_sign_member_number', 'no_sign_member_number', 'unqualified_member_number', 'total_evaluate_number', 'good_evaluate_number', 'middle_evaluate_number', 'bad_evaluate_number'], 'integer'],
